...
# Doc file .env thu cong tu thu muc goc cua du an (/app/.env)
...
def test_bruteforce_flow():
    ...
    # Gia lap 3 lan quet the that bai lien tiep de kich hoat thuat toan Bruteforce
    card_id = "CARD-999999"
    gate_id = "gate-a"
    location = "Cổng chính A"

    print(f"[Test] Starting to publish 3 denied events for {card_id} at {location}...")
    for i in range(3):
        payload = {
            "uid": card_id,
